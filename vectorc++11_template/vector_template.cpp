//
// Project: vectorc++11_template
// Filename: vector_template.cpp
// Creator: Jean-François Ndi
// Creation Date: 3-1-2024 @ 10:10 AM
//
#include <cassert>
#include <iostream>
#include <memory>
...
std::ostream& operator<<(std::ostream& os, vector<Value>& v)
{
	os << '[';
	if (v.size() > 0)
		os << v[0];
