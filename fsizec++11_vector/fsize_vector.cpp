//
// Project: fsizec++11_vector
// Filename: fsize_vector.cpp
// Creator: Jean-François Ndi
// Creation Date: 16-1-2024 @ 10:37 AM
//
#include <cassert>
#include <iostream>
#include <cmath>
...
typename Vector::value_type
inline accumulate(const Vector& v, F& f)
{
